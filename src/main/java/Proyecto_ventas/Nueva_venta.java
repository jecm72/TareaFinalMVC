...
public class Nueva_venta {
    ...
    public void filtro_panel() {
        ...
        telefono.setBounds(520, 100, 160, 30);
        ...
        verificar = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (telefono.getText().trim().equals("")) {
                    ...
                    telefono_uso = Integer.parseInt(telefono.getText().trim());

                }

                ClientesDAO cd = new ClientesDAO();
                nombres = cd.filtro(nombres_uso, nit_uso, correo_uso, telefono_uso);
    ...
    private void crear() {
        ...
        ActionListener guardar = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ClientesDAO cd = new ClientesDAO();
                cd.crear(Integer.parseInt(t1.getText()), t2.getText(),t3.getText(), t4.getText(), Integer.parseInt(t5.getText()));
